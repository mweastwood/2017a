...
\begin{figure*}[ht]
    \gridline{
        \fig{figures/beam/source-tracks}{0.45\textwidth}{(a)}
        \fig{figures/beam/stokes-I-beam}{0.45\textwidth}{(b)}
    }
    \caption{
        Example beam model (from spw04).
    }
    \label{fig:beam}
\end{figure*}
...
zenith is constrained to be unity.

\todo{plot that shows the tracks after symmetries applied and the resulting beam fit?}
