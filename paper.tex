...
\todo{this entire section needs a rewrite, it is way too rambling}
...
%scattering, absorption, or additional emission can perturb or corrupt the thermal CMB spectrum. In
%order to measure the pristine CMB, these foreground components (eg. synchrotron emission, free-free
%emission, thermal dust emission) are a nuisance and careful modeling and removal of these components
%is essential \citep{2016A&A...594A..10P, 2016A&A...594A..25P}.
%
...
remnants, radio galaxies, free-free emission and absorption from \ion{H}{2} regions, and a confusing
...
to baseline foreshortening. An example computed PSF is shown in Figure~\ref{fig:psf}.  Adapting
CLEAN for $m$-mode analysis requires either pre-computing Equation~\ref{eq:psf} at a grid of
declinations, or a method for rapidly evaluating Equation~\ref{eq:psf} on the fly.

\todo{cite lincoln's paper on cleaning with a changing psf}
...
\begin{figure*}[t]
    ...
    \caption{
        Light curves for Cyg A and Cas A.
    }
...
Figure~\ref{fig:vtec} shows the median vertical total electron content (TEC) above OVRO measured
with the GIM \todo{citation}. The median is computed over all GPS measurements within 200 km of the
observatory. Over the observing period the TEC smoothly varies from 20 TECU at midday to 5 TECU
during the night. However, this measurement is sensitive to large scale fluctuations in the
ionosphere and doesn't capture small scale fluctuations.
...
\begin{table*}[t]
    ...
    \begin{tabular}{ccccccccc}
        ...
        & \tbf{Frequency} & \tbf{Bandwidth} & \tbf{FWHM} &
            ...
            \multicolumn2c{\tbf{Singular Values}} \\
        \cline{5-6}
        \cline{8-9}
        \tbf{\#} & MHz & MHz & arcmin &
            K & Jy &&
            fraction $>\sqrt{\varepsilon}$ &
            fraction $>10\sqrt{\varepsilon}$ \\
        \hline
        1 & 36.528 & 0.024 &  &  & & & \\
        2 & 41.760 & 0.024 &  &  & & & \\
        3 & 46.992 & 0.024 &  &  & & & \\
...
%\begin{figure*}[p]
%    \centering
%    \includegraphics[width=0.9\textheight, angle=90]{maps/2017-04-20-rgb-map-smaller}
%    \caption{
...
%\begin{figure*}[p]
%    \gridline{
%        \fig{figures/jackknife-maps/4.pdf}
%            {0.48\textwidth}{}
%        \fig{figures/jackknife-maps/6.pdf}
%            {0.48\textwidth}{}
%    }
%    \gridline{
%        \fig{figures/jackknife-maps/8.pdf}
%            {0.48\textwidth}{}
%        \fig{figures/jackknife-maps/10.pdf}
%            {0.48\textwidth}{}
%    }
%    \gridline{
%        \fig{figures/jackknife-maps/12.pdf}
%            {0.48\textwidth}{}
%        \fig{figures/jackknife-maps/14.pdf}
%            {0.48\textwidth}{}
%    }
%    \gridline{
%        \fig{figures/jackknife-maps/16.pdf}
%            {0.48\textwidth}{}
%        \fig{figures/jackknife-maps/18.pdf}
%            {0.48\textwidth}{}
%    }
%    \caption{
...
%
%The Global Sky Model (GSM) \citep{2008MNRAS.388..247D, 2017MNRAS.464.3486Z}

\subsection{Haslam 408 MHz Map}

\begin{figure}[t]
    \plotone{figures/haslam/haslam-spectral-index}
    \caption{
...
\begin{figure}[t]
    \plotone{figures/guzman/guzman-comparison}
    \caption{
