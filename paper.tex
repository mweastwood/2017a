...
\begin{figure*}[ht]
    ...
    \caption{
        ...
        \citep{2014MNRAS.444..606O} \textbf{(a)} This image shows the initial data before any
        sources have been removed. \textbf{(b)} This image shows the final state after 3
        terrestrial sources of correlated noise have been removed. \textbf{(c)} This image
        illustrates the contribution of an RFI source towards the north-west that was removed by
        peeling. \textbf{(d)} This removed component is not associated with a dot on the horizon.
        Instead it is likely associated with common-mode pickup in the analog signal chain.
    }
\end{figure*}
...
%These model visibilities are then scaled and subtracted from each
...
\section{A Nearby Supernova Remnant????}


\section{Discussion}

These maps are pretty cool. Any questions?
