...
Other bright sources -- namely Vir~A, Tau~A, Her~A, Hya~A, Per~B, and 3C~353 -- are also removed
...
This filtering creates negative rings around the NCP at the declination of bright point sources, but
...
will be included in future work.  Instead, temperature-temperature plots (T-T plot) can be used to
...
can be seen with higher resolution in Figure~\ref{fig:three-color}. Along the galactic plane,
especially towards the galactic center, \ion{H}{2} regions appear as blue shadows due to free-free
absorption.
...
LWA1 map. The dominant feature in this map is a shift of the galactic plane. This feature is also
...
low-frequency measurements in the literature in six different directions.
