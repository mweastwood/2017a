...
rc("axes", labelweight="light", linewidth=1.2)
...
scatter(east[leda], north[leda], marker="+", c="k", s=80, lw=1.2)
scatter(east[expansion], north[expansion], marker="o", c=transparent, s=40, lw=1.2)
...
gca()[:get_xaxis]()[:set_tick_params](width=1.2, size=5)
gca()[:get_yaxis]()[:set_tick_params](width=1.2, size=5)
grid("off")
